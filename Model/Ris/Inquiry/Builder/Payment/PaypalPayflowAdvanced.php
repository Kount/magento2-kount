...
class PaypalPayflowAdvanced extends \Swarming\Kount\Model\Ris\Update\Builder\Payment\PaypalPayflowLink implements PaymentInterface
{
    /**
    ...
    public function process(\Kount_Ris_Request $request, OrderPaymentInterface $payment)
    {
        ...
        $request->setUserDefinedField('payment_type', 'payflow_advanced');
